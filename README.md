...
**Note:** This project was developed with AI assistance. The memory architecture and proxy logic were co-created with large language models, with testing conducted using Qwen3.6 (35B A3B) and implementation built with Opencode's Big Pickle.
